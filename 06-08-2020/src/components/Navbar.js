...
const NavBar = ({ }) => {
    ...
    return (
        ...
        <Navbar className="navbar"  >
            ...
            <Navbar.Collapse id="basic-navbar-nav">
                <Nav className="mr-auto">
                    ...
                    <Nav.Link href="/CaixadAgua"><b>Caixa d'Água</b></Nav.Link>
                    <NavDropdown title="Andares" className="tituloAndares" id="basic-nav-dropdown">
        ...
        <Switch>
            ...
            <Route path='/CaixadAgua' component={CaixadAgua} />
